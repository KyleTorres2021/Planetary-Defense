...
public class PopupEvent_Manager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        events.Add(new PopupEvent("''Pst! Hey you! Over here!'' A voice calls out to you from your office window. Peering outside, you spot a shifty looking man with raider tattoos hanging from the ledge." +
            "''How'd you like to make some easy money? My mates found an easy score that you could take part in. All you have to do is look the other way.''\n \n" + "Let the raiders perform their heist?\n" +
            "-15 Stability, +$700",
        ...
        events.Add(new PopupEvent("The silence of is broken by someone clearing their throat over the radio. ''H-Hello Governor-- I mean, Sweetheart! This is your, uh... Grandmother, here to wish you a " +
            ...
            "There is a brief moment of silence before your grandmother speaks up ''Thank you, Honey, I'll see you soon!'' A moment later, you catch another voice hidden in the static. ''Oh my god, I can't " +
                "believe that worked!''\n \n Sadly, your birdthday cake never arrives. All you get is a mysterious ''outtage'' of your defenses and a bunch of supplies reported stollen. \n \n -$50, -2 Stability",
